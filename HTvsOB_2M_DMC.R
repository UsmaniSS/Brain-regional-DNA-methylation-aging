...
files_bam <- list(OB_Y1, OB_Y2, OB_Y3, HT_Y1, HT_Y2, HT_Y3)
my.methRaw=processBismarkAln(files_bam,
                             sample.id = list("OB_Y1", "OB_Y2", "OB_Y3", "HT_Y1", "HT_Y2","HT_Y3"),
                             assembly = "mm10",
                             read.context = "CpG",
                             mincov = 10,
                             minqual = 20,
...
OB_Y1_CpG <- "OB_Y1_CpG.txt"
OB_Y2_CpG <- "OB_Y2_CpG.txt"
OB_Y3_CpG <- "OB_Y3_CpG.txt"
HT_Y1_CpG <- "HT_Y1_CpG.txt"
HT_Y2_CpG <- "HT_Y2_CpG.txt"
HT_Y3_CpG <- "HT_Y3_CpG.txt"


file_2.list <- list(OB_Y1_CpG, OB_Y2_CpG, OB_Y3_CpG, HT_Y1_CpG, HT_Y2_CpG, HT_Y3_CpG)
myobj = methRead(file_2.list,
                 sample.id = list("OB_Y1_CpG", "OB_Y2_CpG", "OB_Y3_CpG", "HT_Y1_CpG", "HT_Y2_CpG", "HT_Y3_CpG"),
                 assembly = "mm10",
                 pipeline = "bismark",
                 context = "CpG",
                 resolution = "base",
...
OB_Y1_CHG <- "OB_Y1_CHG.txt"
OB_Y2_CHG <- "OB_Y2_CHG.txt"
OB_Y3_CHG <- "OB_Y3_CHG.txt"
HT_Y1_CHG <- "HT_Y1_CHG.txt"
HT_Y2_CHG <- "HT_Y2_CHG.txt"
HT_Y3_CHG <- "HT_Y3_CHG.txt"


file_1.list <- list(OB_Y1_CHG, OB_Y2_CHG, OB_Y3_CHG, HT_Y1_CHG, HT_Y2_CHG, HT_Y3_CHG)

myobj=methRead(file_1.list,
               sample.id=list("OB_Y1_CHG", "OB_Y2_CHG", "OB_Y3_CHG", "HT_Y1_CHG", "HT_Y2_CHG", "HT_Y3_CHG"),
               assembly="mm10",
               pipeline="bismark",
               context="CHG",
               resolution="base",
...
OB_Y1_CHH <- "OB_Y1_CHH.txt"
OB_Y2_CHH <- "OB_Y2_CHH.txt"
OB_Y3_CHH <- "OB_Y3_CHH.txt"
HT_Y1_CHH <- "HT_Y1_CHH.txt"
HT_Y2_CHH <- "HT_Y2_CHH.txt"
HT_Y3_CHH <- "HT_Y3_CHH.txt"


file_1.list <- list(OB_Y1_CHH, OB_Y2_CHH, OB_Y3_CHH, HT_Y1_CHH, HT_Y2_CHH, HT_Y3_CHH)

myobj=methRead(file_1.list,
               sample.id=list("OB_Y1_CHH", "OB_Y2_CHH", "OB_Y3_CHH", "HT_Y1_CHH", "HT_Y2_CHH", "HT_Y3_CHH"),
               assembly="mm10",
               pipeline="bismark",
               context="CHH",
               resolution="base",
