...
files_bam <- list(OB_O1, OB_O2, OB_O3, HT_O1, HT_O2, HT_O3)
my.methRaw=processBismarkAln(files_bam,
                             sample.id = list("OB_O1", "OB_O2", "OB_O3", "HT_O1", "HT_O2","HT_O3"),
                             assembly = "mm10",
                             read.context = "CpG",
                             mincov = 10,
                             minqual = 20,
...
file_2.list <- list(OB_O1_CpG, OB_O2_CpG, OB_O3_CpG, HT_O1_CpG, HT_O2_CpG, HT_O3_CpG)
myobj = methRead(file_2.list,
                 sample.id = list("OB_O1_CpG", "OB_O2_CpG", "OB_O3_CpG", "HT_O1_CpG", "HT_O2_CpG", "HT_O3_CpG"),
                 assembly = "mm10",
                 pipeline = "bismark",
                 context = "CpG",
                 resolution = "base",
...
file_1.list <- list(OB_O1_CHG, OB_O2_CHG, OB_O3_CHG, HT_O1_CHG, HT_O2_CHG, HT_O3_CHG)

myobj=methRead(file_1.list,
               sample.id=list("OB_O1_CHG", "OB_O2_CHG", "OB_O3_CHG", "HT_O1_CHG", "HT_O2_CHG", "HT_O3_CHG"),
               assembly="mm10",
               pipeline="bismark",
               context="CHG",
               resolution="base",
...
file_1.list <- list(OB_O1_CHH, OB_O2_CHH, OB_O3_CHH, HT_O1_CHH, HT_O2_CHH, HT_O3_CHH)

myobj=methRead(file_1.list,
               sample.id=list("OB_O1_CHH", "OB_O2_CHH", "OB_O3_CHH", "HT_O1_CHH", "HT_O2_CHH", "HT_O3_CHH"),
               assembly="mm10",
               pipeline="bismark",
               context="CHH",
               resolution="base",
