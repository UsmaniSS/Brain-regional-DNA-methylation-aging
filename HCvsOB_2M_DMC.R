...
files_bam <- list(OB_Y1, OB_Y2, OB_Y3, HC_Y1, HC_Y2, HC_Y3)
my.methRaw=processBismarkAln(files_bam,
                             sample.id = list("OB_Y1", "OB_Y2", "OB_Y3", "HC_Y1", "HC_Y2","HC_Y3"),
                             assembly = "mm10",
                             read.context = "CpG",
                             mincov = 10,
                             minqual = 20,
...
file_2.list <- list(OB_Y1_CpG, OB_Y2_CpG, OB_Y3_CpG, HC_Y1_CpG, HC_Y2_CpG, HC_Y3_CpG)
myobj = methRead(file_2.list,
                 sample.id = list("OB_Y1_CpG", "OB_Y2_CpG", "OB_Y3_CpG", "HC_Y1_CpG", "HC_Y2_CpG", "HC_Y3_CpG"),
                 assembly = "mm10",
                 pipeline = "bismark",
                 context = "CpG",
                 resolution = "base",
...
file_1.list <- list(OB_Y1_CHG, OB_Y2_CHG, OB_Y3_CHG, HC_Y1_CHG, HC_Y2_CHG, HC_Y3_CHG)

myobj=methRead(file_1.list,
               sample.id=list("OB_Y1_CHG", "OB_Y2_CHG", "OB_Y3_CHG", "HC_Y1_CHG", "HC_Y2_CHG", "HC_Y3_CHG"),
               assembly="mm10",
               pipeline="bismark",
               context="CHG",
               resolution="base",
...
file_1.list <- list(OB_Y1_CHH, OB_Y2_CHH, OB_Y3_CHH, HC_Y1_CHH, HC_Y2_CHH, HC_Y3_CHH)

myobj=methRead(file_1.list,
               sample.id=list("OB_Y1_CHH", "OB_Y2_CHH", "OB_Y3_CHH", "HC_Y1_CHH", "HC_Y2_CHH", "HC_Y3_CHH"),
               assembly="mm10",
               pipeline="bismark",
               context="CHH",
               resolution="base",
