...
file_1.list <- list(HC_Y1_CpG, HC_Y2_CpG, HC_Y3_CpG, HC_O1_CpG, HC_O2_CpG, HC_O3_CpG)
myobj=methRead(file_1.list, 
               sample.id=list("HC_Y1_CpG", "HC_Y2_CpG", "HC_Y3_CpG", "HC_O1_CpG", "HC_O2_CpG", "HC_O3_CpG"),
               assembly="mm10",
               pipeline="bismark",
               context="CpG",
               resolution="base",
