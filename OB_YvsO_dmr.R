...
file_1.list <- list(OB_Y1_CpG, OB_Y2_CpG, OB_Y3_CpG, OB_O1_CpG, OB_O2_CpG, OB_O3_CpG)
myobj=methRead(file_1.list, 
               sample.id=list("OB_Y1_CpG", "OB_Y2_CpG", "OB_Y3_CpG", "OB_O1_CpG", "OB_O2_CpG", "OB_O3_CpG"),
               assembly="mm10",
               pipeline="bismark", 
               context="CpG", 
               resolution="base",
