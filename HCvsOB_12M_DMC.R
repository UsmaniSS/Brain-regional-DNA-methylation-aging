...
files_bam <- list(OB_O1, OB_O2, OB_O3, HC_O1, HC_O2, HC_O3)
my.methRaw=processBismarkAln(files_bam,
                             sample.id = list("OB_O1", "OB_O2", "OB_O3", "HC_O1", "HC_O2","HC_O3"),
                             assembly = "mm10",
                             read.context = "CpG",
                             mincov = 10,
                             minqual = 20,
...
OB_O1_CpG <- "OB_O1_CpG.txt"
OB_O2_CpG <- "OB_O2_CpG.txt"
OB_O3_CpG <- "OB_O3_CpG.txt"
HC_O1_CpG <- "HC_O1_CpG.txt"
HC_O2_CpG <- "HC_O2_CpG.txt"
HC_O3_CpG <- "HC_O3_CpG.txt"


file_2.list <- list(OB_O1_CpG, OB_O2_CpG, OB_O3_CpG, HC_O1_CpG, HC_O2_CpG, HC_O3_CpG)
myobj = methRead(file_2.list,
                 sample.id = list("OB_O1_CpG", "OB_O2_CpG", "OB_O3_CpG", "HC_O1_CpG", "HC_O2_CpG", "HC_O3_CpG"),
                 assembly = "mm10",
                 pipeline = "bismark",
                 context = "CpG",
                 resolution = "base",
...
OB_O1_CHG <- "OB_O1_CHG.txt"
OB_O2_CHG <- "OB_O2_CHG.txt"
OB_O3_CHG <- "OB_O3_CHG.txt"
HC_O1_CHG <- "HC_O1_CHG.txt"
HC_O2_CHG <- "HC_O2_CHG.txt"
HC_O3_CHG <- "HC_O3_CHG.txt"


file_1.list <- list(OB_O1_CHG, OB_O2_CHG, OB_O3_CHG, HC_O1_CHG, HC_O2_CHG, HC_O3_CHG)

myobj=methRead(file_1.list,
               sample.id=list("OB_O1_CHG", "OB_O2_CHG", "OB_O3_CHG", "HC_O1_CHG", "HC_O2_CHG", "HC_O3_CHG"),
               assembly="mm10",
               pipeline="bismark",
               context="CHG",
               resolution="base",
...
OB_O1_CHH <- "OB_O1_CHH.txt"
OB_O2_CHH <- "OB_O2_CHH.txt"
OB_O3_CHH <- "OB_O3_CHH.txt"
HC_O1_CHH <- "HC_O1_CHH.txt"
HC_O2_CHH <- "HC_O2_CHH.txt"
HC_O3_CHH <- "HC_O3_CHH.txt"


file_1.list <- list(OB_O1_CHH, OB_O2_CHH, OB_O3_CHH, HC_O1_CHH, HC_O2_CHH, HC_O3_CHH)

myobj=methRead(file_1.list,
               sample.id=list("OB_O1_CHH", "OB_O2_CHH", "OB_O3_CHH", "HC_O1_CHH", "HC_O2_CHH", "HC_O3_CHH"),
               assembly="mm10",
               pipeline="bismark",
               context="CHH",
               resolution="base",
